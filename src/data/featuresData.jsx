const featuresData = [
  {
    ...
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 41" className="fill-current">
        <path opacity="0.5" d="M20 2C9.063 2 1 10.063 1 21s8.063 19 19 19 19-8.063 19-19S30.937 2 20 2zM20 32c-6.074 0-11-4.926-11-11s4.926-11 11-11 11 4.926 11 11-4.926 11-11 11z" />
  ...
  },
  {
    ...
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 41" className="fill-current">
        <path opacity="0.5" d="M32 2H8C6.895 2 6 2.895 6 4v32c0 1.105.895 2 2 2h24c1.105 0 2-.895 2-2V4c0-1.105-.895-2-2-2zM8 4h24c.553 0 1 .447 1 1v30c0 .553-.447 1-1 1H8c-.553 0-1-.447-1-1V5c0-.553.447-1 1-1z" />
  ...
  },
  {
    ...
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 41" className="fill-current">
        <path opacity="0.5" d="M20 2C11.163 2 4 9.163 4 18v14c0 1.105.895 2 2 2h28c1.105 0 2-.895 2-2V18c0-8.837-7.163-16-16-16zM8 18c0-6.627 5.373-12 12-12s12 5.373 12 12v10H8V18z" />
  ...
  },
  {
    ...
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 41" className="fill-current">
        <path opacity="0.5" d="M20 2C10.058 2 2 10.058 2 20s8.058 18 18 18 18-8.058 18-18S29.942 2 20 2zM18 27h-4v-4h4v4zm0-6h-4v-4h4v4zm6 6h-4v-4h4v4zm0-6h-4v-4h4v4z" />
        <path d="M12 8h16v4H12V8zm-2 6h20v2H10v-2zm2 4h16v4H12v-4z" />
      </svg>
    ),
    title: "Knowledge Exploration",
    paragraph: "Facilitating the discovery of new information and learning opportunities using AI.",
  },
];
