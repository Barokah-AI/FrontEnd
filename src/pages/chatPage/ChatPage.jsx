  ...
  return (
    <>
      ...
      <div className="drawer sticky top-0 inset-x-0 z-30 bg-white border-y px-4 sm:px-6 md:px-8 lg:hidden dark:bg-dark dark:border-y-neutral-700">
        ...
        <div className="drawer-content flex justify-between items-center py-3 space-x-5">
        ...
        <div className="pt-10 pb-24 sm:pb-0 sm:min-h-screen sm:pt-14">
          ...
          <div className="max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto text-center">
            ...
            <p className="text-sm mt-3 text-gray-600 dark:text-neutral-400">
              There is nothing hidden in this world
            </p>
            <p className="text-sm mt-3 text-gray-600 dark:text-neutral-400">
              BarokahAi is here to help you know everything
            </p>
          </div>
          {/* End Title */}
            ...
            <div role="alert" className="alert mb-4">
              ...
              <div>
                <h3 className="font-bold">
                  You Have Reached the Limit of 3 Chats!!!
                </h3>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-x-1">
                  <button
                    ...
                    type="submit"
                    disabled={
                      isLoading || (responseCount >= 3 && !isUserLoggedIn)
                    }
