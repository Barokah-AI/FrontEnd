          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <div className="flex gap-2 mb-2">
                  <img src="https://github.com/Barokah-AI/BackEnd/assets/94734096/0bf32c79-e402-4565-9868-8a21c84d8b33" alt="Image Description" className="w-10 h-auto" />
                  <div>
                    <h1 className="mt-1 text-2xl font-bold text-primary">BarokahAI</h1>
                  </div>
                </div>
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark">For the latest updates, latest news, and interesting content from Barokah AI, don&apos;t forget to follow us on social media!!!
                  that we have provided below. Thank you for your attention and support.
                </p>
                <div className="flex items-center">
                  ...
                  <Link to="/" aria-label="social-link" target="_blank" rel="noopener noreferrer" className="text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary">
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
              <div className="mb-10 w-full">
                <h4 className="mb-9 text-lg font-semibold text-dark dark:text-dark">Relevant Links</h4>
                <ul>
                  {menuData.map((menuItem) => (
                    <li key={menuItem.id}>
                      <a href={menuItem.path} className="mb-2 inline-block text-base leading-loose text-body-color hover:text-primary dark:text-body-color-dark dark:hover:text-primary">
                        {menuItem.title}
                      </a>
                    </li>
                  ))}
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-xl font-bold text-black dark:text-white">Terms & Condition</h2>
                <ul>
                  <li>
