...
const Hero = () => {
  return (
    <>
      <section
        id="home"
        className="relative z-10 overflow-hidden bg-white pb-12 pt-[120px] dark:bg-gray-dark md:pb-[50px] md:pt-[120px] xl:pb-[20px] xl:pt-[140px]"
      >
              ...
              <div className="mx-auto max-w-[800px] text-center">
                ...
                <div className="flex items-center justify-center">
                  <img
                    ...
                    src="https://github.com/Barokah-AI/FrontEnd/assets/94734096/99a31d0b-c66a-486c-9603-7baacd931aa7"
                    alt="hero-image"
                  />
                </div>
              </div>
